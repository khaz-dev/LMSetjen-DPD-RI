...
import { createImageErrorHandler, getFirstValidImageUrl } from "../../../utils/imageUtils";
import "./Header.css";
    ...
    if (loading) {
      return (
        <div className="instructor-default-avatar loading-shimmer-instructor mx-auto">
          <div className="spinner-border text-white" role="status" style={{ width: "2.5rem", height: "2.5rem", flexShrink: 0 }}>
