...
import "./ReviewAbuseAdmin.css";

function ReviewAbuseAdmin() {
    ...
    const fetchAbuseReports = async () => {
        try {
            ...
            console.log("[ReviewAbuseAdmin] API Response:", response.data);
            ...
            console.log(`[ReviewAbuseAdmin] Found ${data.length} reports`);
            setReports(data);
        } catch (error) {
    ...
    return (
        <>
            ...
            <div className="review-abuse-admin-page pt-5 pb-5">
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-8">
                                <h2 className="page-title mb-1">
                                    ...
                                    Laporan Penyalahgunaan Review
                                </h2>
                                <p className="page-subtitle">Kelola laporan penyalahgunaan yang dikirim oleh instruktur</p>
                            </div>
                            <div className="col-md-4 text-end">
                                <div className="stat-card">
                                    <div className="stat-value text-danger">{reports.length}</div>
