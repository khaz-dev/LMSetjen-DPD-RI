...
/**
 * ✨ PHASE 53: Activities Page
 * Full activity history view with comprehensive filtering and pagination
 */
function Activities() {
    ...
    const fetchData = async () => {
        try {
            // Fetch courses first
            const coursesRes = await useAxios.get(`student/course-list/${UserData()?.user_id}/`);
    ...
    useEffect(() => {
        const fetchActivities = async () => {
            try {
                ...
                const response = await useAxios.get(`student/activities/?${params.toString()}`);
    ...
    if (fetching) {
        return (
            <>
                <BaseHeader />
                <section className="activities-page" style={{ minHeight: "calc(100vh - 120px)" }}>
                        ...
                        <div className="row mt-0">
                            ...
                            <div className="col-lg-9 col-md-8 col-12" style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "60vh" }}>
                                <div className="text-center">
                                    ...
                                    <p className="mt-3 text-muted">Memuat aktivitas Anda...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row mt-0 md-4">
                        ...
                        <div className={`col-lg-9 col-md-8 col-12 ${isCollapsed ? "sidebar-collapsed-adapted" : ""}`}>
                            ...
                            <div className="page-header">
                                ...
                                <p className="text-muted mb-0">Lihat semua aktivitas belajar Anda</p>
                            </div>
                            ...
                            <div className="page-size-selector mb-3" style={{
                                ...
                                <small className="text-muted">
                                    Menampilkan {activities.length > 0 ? (page - 1) * pageSize + 1 : 0} hingga {Math.min(page * pageSize, totalCount)} dari {totalCount} aktivitas
                                </small>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                    <label htmlFor="pageSize" className="form-label small mb-0">Aktivitas per halaman:</label>
                                    <select
                                        id="pageSize"
                            ...
                            <div className="activities-container">
                                {loading ? (
                                    <div className="text-center py-5">
                                        ...
                                        <p className="text-muted mt-2">Memuat aktivitas...</p>
                                    </div>
                                ) : activities.length > 0 ? (
                                    ...
                                    <div className="text-center py-5" style={{ color: '#999' }}>
                                        ...
                                        <p className="fs-5">Tidak ada aktivitas</p>
