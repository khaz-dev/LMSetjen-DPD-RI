...
function ChangePassword() {
    ...
    const renderPasswordField = (field, icon, label, placeholder) => (
        <div className="student-password-field-container">
            <label className="student-password-label" htmlFor={field}>
    ...
    const renderSecurityTips = () => (
        <div className="student-security-tips">
            <h6 className="student-security-tips-title">
                <i className="student-security-tips-icon fas fa-lightbulb"></i>
                Password Security Tips
            </h6>
            <div className="student-security-tips-grid">
                <div className="student-security-tip-item">
                    <i className="student-security-tip-icon fas fa-check-circle"></i>
    ...
    return (
        <>
            <BaseHeader />
            <section className="student-password-page pt-5 pb-5">
                        ...
                        <div className="col-lg-9 col-md-8 col-12">
                            ...
                            <div className="student-password-header mb-4">
                                ...
                                <div className="position-relative">
                                    <h1 className="student-password-title mb-2">
                                        <i className="fas fa-shield-alt me-3"></i>Change Password
                                    </h1>
                                    <p className="student-password-subtitle text-muted">
